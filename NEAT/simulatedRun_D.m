...
function [population_updated] = simulatedRun_D(MAV, grid, sim, population, MS_neat)
...
% obstacle_penalty = 2; % negative penalty applied to the fitness when the agent hits an obstacle
% bonous = 4;    %Bonous fitness gain
% visitedCell = 0;    %Boolean determines if cell has been visited by MAV during the time step
% lookahead_time = 1; %--Used for the age map gradient in the fitness function
% weight_grad = 1.5;  %--Used for the age map gradient in the fitness function
